...
public:
	...
	void teachdel2m(vector<double >& delta3m, int64_t& Quoter, vector<vector<double>>& Weights3m, vector<vector<double>>& Weights2m, vector<vector<double>>& Outputs2m, vector<double >& delta2m);
	...
	void teachdel2mam(vector<double >& delta3m, int64_t& Quoter, vector<vector<double>>& Weights3m, vector<vector<double>>& Weights2m, vector<vector<double>>& Outputs2m, vector<double >& delta2m, double*& vec_a, double*& vec_b, double*& vec_c, double*& vec_d);
	void teach2mam(int64_t& Quoter, vector<vector<double>>& Outputs2m, double alpham, vector<vector<double>>& Weights2m, vector<double >& delta2m, double*& vec_d, double*& vec_a);
