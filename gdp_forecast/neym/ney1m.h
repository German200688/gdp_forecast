...
public:
	...
	void teachdel1m(vector<double >& delta2m, int64_t& Quoter, vector<vector<double>>& Weights2m, vector<double>& Weights1m, vector<vector<double>>& Outputs1m, vector<double >& delta1m);
