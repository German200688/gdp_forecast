...
void layer4m::neyronoutindadd4m(vector<vector<signed char>>& Outputs4m, vector<int64_t>& Count, int64_t& CountOutputs4)
...
void layer4m::neyronoutqadd4m(vector<vector<signed char>>& Outputs4m, int64_t Quoter)
...
void layer4m::weightsaddl34m(vector<vector<signed char>>& Weights4m, int64_t ney1)
...
void layer4m::weightsaddl44m(vector<vector<signed char>>& Weights4m, int64_t CountWeights4)
...
void layer4m::summneyquoter4m(vector<int64_t>& Count, vector<vector<signed char>>& Outputs3m, vector<vector<signed char>>& Weights4m, vector<vector<signed char>>& Outputs4m, int64_t Quoter) //квартал идет от 0 у каждого нейрона свой вектор
...
void layer4m::summneyall4m(vector<int64_t>& Count, vector<vector<signed char>>& Outputs3m, vector<vector<signed char>>& Weights4m, vector<vector<signed char>>& Outputs4m)
...
void layer4m::teachdel4m(vector<signed char >& delta5m, int64_t& Quoter, vector<vector<signed char>>& Weights5m, vector<vector<signed char>>& Weights4m, vector<vector<signed char>>& Outputs4m, vector<signed char >& delta4m)
...
void layer4m::teachdel4mam(vector<signed char >& delta5m, int64_t& Quoter, vector<vector<signed char>>& Weights5m, vector<vector<signed char>>& Weights4m, vector<vector<signed char>>& Outputs4m, vector<signed char >& delta4m, signed char*& dvec_a4, signed char*& dvec_b4, signed char*& dvec_c4, signed char*& ab)
...
void layer4m::teach4m(int64_t& Quoter, vector<vector<signed char>>& Outputs4m, signed char alpha, vector<vector<signed char>>& Weights4m, vector<signed char >& delta4m)
...
void layer4m::teach4mam(int64_t& Quoter, vector<vector<signed char>>& Outputs4m, signed char alpham, vector<vector<signed char>>& Weights4m, vector<signed char >& delta4m, signed char*& vec_d, signed char*& vec_a)
