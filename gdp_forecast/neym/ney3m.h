...
public:
	...
	void teachdel3m(vector<double >& delta4m, int64_t& Quoter, vector<vector<double>>& Weights4m, vector<vector<double>>& Weights3m, vector<vector<double>>& Outputs3m, vector<vector<double>>& Outputs2m, vector<double >& delta3m, double alpha);
	...
	void teachdel3mam(vector<double >& delta4m, int64_t& Quoter, vector<vector<double>>& Weights4m, vector<vector<double>>& Weights3m, vector<vector<double>>& Outputs3m, vector<vector<double>>& Outputs2m, vector<double >& delta3, double*& vec_a, double*& vec_b, double*& vec_c, double*& vec_d, double alpha);
	void teach3mam(int64_t& Quoter, vector<vector<double>>& Outputs3m, double alpham, vector<vector<double>>& Weights3m, vector<double >& delta3m, double*& vec_d, double*& vec_a, double*& vec_b);
