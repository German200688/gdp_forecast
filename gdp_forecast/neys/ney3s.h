...
public:
	...
	void teachdel3(vector<double >& delta4, int64_t& Quoter, vector<vector<double>>& Weights4, vector<vector<double>>& Weights3, vector<vector<double>>& Outputs3, vector<double >& delta3);
	void teach3(int64_t& Quoter, vector<vector<double>>& Outputs3, double alpha, vector<vector<double>>& Weights3, vector<double >& delta3);
	void teachdel3ma(vector<double >& delta4, int64_t& Quoter, vector<vector<double>>& Weights4, vector<vector<double>>& Weights3, vector<vector<double>>& Outputs3, vector<double >& delta3, double*& dvec_a23, double*& dvec_b23);
	void teach3ma(int64_t& Quoter, vector<vector<double>>& Outputs3, double alpha, vector<vector<double>>& Weights3, vector<double >& delta3, double*& vec_d, double*& vec_a);
