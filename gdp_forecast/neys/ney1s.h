...
public:
	...
	void teachdel1(vector<double >& delta2, int64_t& Quoter, vector<vector<double>>& Weights2, vector<double>& Weights1, vector<vector<double>>& Outputs1, vector<double >& delta1, double alpha);
	void teach1(int64_t& Quoter, vector<vector<double>>& Outputs1, double alpha, vector<double>& Weights1, vector<double >& delta1);
	void teachdel1ma(vector<double >& delta2, int64_t& Quoter, vector<vector<double>>& Weights2, vector<double>& Weights1, vector<vector<double>>& Outputs1, vector<double >& delta1, double*& dvec_a1, double*& dvec_b1, double*& dvec_c1, double alpha);
